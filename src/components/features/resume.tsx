          ...
          <FloatSection>
            <Card className="hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent className="text-gray-600 text-md">
                <span>
                  Recent Information Technology graduate passionate about web
                  development and eager to learn emerging technologies. Skilled
                  in building responsive web applications and committed to
        ...
        <div className="flex flex-col w-full md:w-[250px] col-span-1 gap-8">
          <FloatSection>
            <Card className="w-full h-max hover:shadow-xl transition-shadow duration-300">
              ...
              <CardContent className="flex flex-col gap-6">
                <a href="./Payos-Kevin-Resume.pdf" download>
